...
cat <<"EOF"
    __  __                          ___              _      __              
   / / / /___  ____ ___  ___       /   |  __________(_)____/ /_____ _____   
  / /_/ / __ \/ __ `__ \/ _ \     / /| | / ___/ ___/ / ___/ __/ __ `/ __ \  
 / __  / /_/ / / / / / /  __/    / ___ |(__  ) (__  ) /_/ /_/ / / / / / /  
/_/ /_/\____/_/ /_/ /_/\___/    /_/  |_/____/____/_/____/\__/_/ /_/_/ /_/   
...
# MODIFIED: Allow all 9.x versions
pve_check() {
  local PVE_VER
  ...
  # Check for Proxmox VE 9.x: allow ANY 9.x
  ...
  msg_error "This version of Proxmox VE is not supported."
  msg_error "Supported versions: Proxmox VE 8.0 – 8.x or 9.x"
  exit 1
}
